    ...
    public function run()
    {
        ...
        DB::insert(
            "INSERT INTO `settings` (`user_id`, `code`, `key`, `value`, `json`, `created_at`, `updated_at`) VALUES
              ...
              (null, 'payment', 'list.wspay', '[{\"title\":\"WSPay\",\"code\":\"wspay\",\"min\":null,\"data\":{\"price\":\"0\",\"short_description\":\"WSPay sustav za internet autorizaciju i naplatu kreditnih i debitnih kartica.\",\"description\":null,\"shop_id\":\"AGMEFRMTST\",\"secret_key\":\"2770f6a0a56c4V\",\"type\":\"1\",\"callback\":\"http:\\/\\/antikvarijat.agm\\/narudzba\",\"test\":\"1\"},\"geo_zone\":null,\"status\":false,\"sort_order\":\"0\"}]', 1, NOW(), NOW()),
              ...
              (null, 'currency', 'list', '[{\"id\":1,\"title\":\"Hrvatska kuna\",\"code\":\"HRK\",\"status\":true,\"main\":true,\"symbol_left\":null,\"symbol_right\":\"kn\",\"value\":\"1\",\"decimal_places\":\"2\"},{\"id\":2,\"title\":\"Euro\",\"code\":\"EUR\",\"status\":false,\"main\":false,\"symbol_left\":\"\\u20ac\",\"symbol_right\":null,\"value\":\"0.13272280\",\"decimal_places\":\"2\"}]', 1, NOW(), NOW()),
              (null, 'language', 'list', '[{\"id\":1,\"title\":\"Hrvatski\",\"code\":\"hr\",\"status\":true,\"main\":true},{\"id\":2,\"title\":\"Engleski\",\"code\":\"en\",\"status\":false,\"main\":false}]', 1, NOW(), NOW()),
