...
@section('content')
    ...
    <section class="position-relative  bg-size-cover bg-position-center-x position-relative py-3 mb-3" style="background-image: url('media/img/indexslika.jpg')">
        <div class="container position-relative zindex-5 py-4 my-3">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="text-light text-center">Lista nakladnika</h1>
                    <p class="pb-0 text-light text-center mb-0">Pretraživanje prema početnom slovu imena nakladnik</p>
            ...
            <div class="col-lg-3 col-md-12 ">
                <ul class="list-group">
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge rounded-pill bg-secondary">14</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <a href="">
                            <span>Algoritam</span>
