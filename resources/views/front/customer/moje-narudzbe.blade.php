        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Broj narudžbe - 34VB5540K83</h5>
                    ...
                    <div class="d-sm-flex justify-content-between mb-4 pb-3 pb-sm-2 border-bottom">
                        <div class="d-sm-flex text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.html" style="width: 10rem;"><img src="img/shop/cart/01.jpg" alt="Product"></a>
                            <div class="ps-sm-4 pt-2">
                                ...
                                <div class="fs-lg text-accent pt-2">154.<small>00</small> kn</div>
                            </div>
                        </div>
                        <div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                            <div class="text-muted mb-2">Količina:</div>1
                        </div>
                        <div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                            <div class="text-muted mb-2">Ukupno</div>154.<small>00</small> kn
                        </div>
                    </div>
                ...
                <div class="modal-footer flex-wrap justify-content-between bg-secondary fs-md">
                    <div class="px-2 py-1"><span class="text-muted">Međusuma:&nbsp;</span><span>265.<small>00</small> kn</span></div>
                    <div class="px-2 py-1"><span class="text-muted">Dostava:&nbsp;</span><span>22.<small>50</small> kn</span></div>
                    <div class="px-2 py-1"><span class="text-muted">PDV:&nbsp;</span><span>9.<small>50</small> kn</span></div>
                    <div class="px-2 py-1"><span class="text-muted">Ukupno:&nbsp;</span><span class="fs-lg">700.<small>00</small> kn</span></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="table-responsive fs-md mb-4">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <td class="py-3"><span>760.50 kn</span></td>
                        </tr>
                        <tr>
