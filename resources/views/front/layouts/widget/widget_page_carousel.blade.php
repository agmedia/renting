    ...
    <div class="container py-lg-3">
        ...
        <div class="tns-carousel pb-5">
            ...
            @foreach ($data['items'] as $item)
                <!-- Product-->
                    <div>
                        <div class="card"><a class="blog-entry-thumb" href="{{ route('catalog.route.blog', ['blog' => $item]) }}"><img class="card-img-top" src="{{ $item['image'] }}" width="400" height="230" alt="{{ $item['title'] }}"></a>
                            <div class="card-body">
