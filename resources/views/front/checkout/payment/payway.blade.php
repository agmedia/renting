<form name="pay" action="{{ $data['action'] }}" method="POST">
    ...
    <div class="d-flex">
        ...
        <div class="w-50 ps-2"><button class="btn btn-primary d-block w-100" type="submit"><span class="d-none d-sm-inline">Dovršite narudžbu</span><span class="d-inline d-sm-none">Nastavi</span><i class="ci-arrow-right mt-sm-0 ms-1"></i></button></div>
    </div>
