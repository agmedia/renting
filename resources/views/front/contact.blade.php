        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 px-4 px-xl-5 py-5 border-top">
                ...
                <form class="needs-validation mb-3" novalidate>
                    <div class="row g-3">
                        <div class="col-sm-12">
                            <label class="form-label" for="cf-name">Vaše ime:&nbsp;<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" id="cf-name" placeholder="" required>
                            <div class="invalid-feedback">Molimo upišite vaše ime!</div>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="cf-email">Email adresa:&nbsp;<span class="text-danger">*</span></label>
                            <input class="form-control" type="email" id="cf-email" placeholder="" required>
                            <div class="invalid-feedback">Molimo upišite ispravno email adresu!</div>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="cf-phone">Broj telefona:&nbsp;<span class="text-danger">*</span></label>
                            <input class="form-control" type="text" id="cf-phone" placeholder="" required>
                            <div class="invalid-feedback">Molimo upišite broj telefona!</div>
                        </div>

                        <div class="col-12">
                            <label class="form-label" for="cf-message">Upit:&nbsp;<span class="text-danger">*</span></label>
                            <textarea class="form-control" id="cf-message" rows="6" placeholder="" required></textarea>
                            <div class="invalid-feedback">Molimo upišite poruku!</div>
