...
@section('content')
    ...
    @if (request()->routeIs(['index']))
        ...
        <!-- Hero section -->
        <section class="bg-accent bg-position-top-left bg-repeat-0 py-5" style="background-image: url('https://images.antikvarijatbibl.lin73.host25.com/media/img/lightslider.jpg');-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
