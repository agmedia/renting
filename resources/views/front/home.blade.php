                                    ...
                                    <div class="col">
                                        <div class="featured-thumb hover-zoomer">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="ps-4 pb-2">
                                                    <span class="location"><i class="fas fa-star text-primary"></i> {{ $apartment->m2 }}m² <i class="fas fa-door-open text-primary"></i> {{ $apartment->rooms }} {{ __('front/apartment.rooms') }}   <i class="fas fa-users text-primary me-1"></i> {{ $apartment->regular_persons }}  {{ __('front/apartment_guests') }}</span>
                                                </div>
