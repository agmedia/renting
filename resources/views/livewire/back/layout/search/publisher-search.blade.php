<div class="mb-0 input-group">
    <input type="search" wire:model.debounce.300ms="search" class="form-control  @error('publisher_id') is-invalid @enderror" id="publisher-input" placeholder="Dodaj autora..." autocomplete="off">
