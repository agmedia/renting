        ...
        <div class="block-content bg-body-dark">
            ...
            <form action="be_pages_ecom_products.html" method="POST" onsubmit="return false;">
                <div class="form-group">
                    <input type="text" class="form-control " id="dm-ecom-products-search" name="dm-ecom-products-search" placeholder="Pretraži autore">
                </div>
            </form>
            <!-- END Search Form -->
        </div>
                ...
                <table class="table table-borderless table-striped table-vcenter">
                    ...
                    <tr>
                        <td class=" font-size-sm">
                            <a class="font-w600" href="{{ route('authors.create') }}">
                                <strong>Murkett Tracey</strong>
                            </a>
                        </td>
                        <td class="text-right" >
