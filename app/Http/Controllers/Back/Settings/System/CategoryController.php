...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('back.settings.system.category.index', compact('categoriess'));
    }
    ...
    public function create()
    {
        ...
        return view('back.settings.system.category.edit', compact('parents', 'groups'));
    }
    ...
    public function edit(Category $category)
    {
        ...
        return view('back.settings.system.category.edit', compact('category', 'parents', 'groups'));
    }
